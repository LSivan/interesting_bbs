...
import (
	"git.oschina.net/gdou-geek-bbs/controllers"
...
func init() {
	...
	beego.InsertFilter("/topic/:id([0-9]+)", beego.BeforeRouter, filters.DetailsChangeFactor)
	...
	beego.Router("/user/:username/topics", &controllers.UserController{}, "GET:Detail")
	beego.Router("/user/:username/replies", &controllers.UserController{}, "GET:Detail")
