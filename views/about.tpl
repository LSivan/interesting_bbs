  ...
  <div class="col-md-9">
    <div class="panel panel-default">
      ...
      <div class="panel-body topic-detail-content">
        ...
        <ul>
          <li><a href="https://github.com/astaxie/beego" target="_blank">github.com/astaxie/beego</a></li>
          <li><a href="https://github.com/astaxie/context" target="_blank">github.com/astaxie/beego/context</a></li>
